...
data:
  config: |
    ...
    - name: my-ip-space
      protocol: layer2
      addresses:
      - 192.168.245.240-192.168.245.249
...
myapp-service   LoadBalancer   10.1.143.177   192.168.245.241   80:31579/TCP   21h
nginx           LoadBalancer   10.1.203.181   192.168.245.240   80:20233/TCP   22h
```
访问测试

```Bash
[root@linux-node1 metallb]# curl http://192.168.245.240
<!DOCTYPE html>
<html>
<head>
